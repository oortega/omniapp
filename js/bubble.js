...
google.bookmarkbubble.Bubble.prototype.build_ = function() {
  ...
  bubbleInner.style.backgroundColor = '#0066CC';
  bubbleInner.style.background = '#ff0000 -webkit-gradient(linear, ' +
      'left bottom, left top, ' + isIpad ?
          'from(#ff0000), to(#0066CC)) no-repeat top' :
          'from(#0066CC), to(#ff0000)) no-repeat bottom';
  ...
  if (this.getIosVersion_() >= this.getVersion_(4, 2)) {
    bubbleInner.innerHTML = 'Install MATCH GAME web app on your iPhone or iPad to make available offline: ' +
